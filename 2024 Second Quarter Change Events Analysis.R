...
data <- read_excel("C:/Users/amrigupt/Downloads/secondquarter2024ChangeEvents.xlsx")
...
#Use the below code to output a count in descending order of the hierarchies with Update_Node change events: 
